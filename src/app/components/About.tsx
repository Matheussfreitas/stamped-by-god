    ...
    <section id={id} className="relative min-h-screen py-20 px-4 bg-white flex items-center justify-center">
      <div className="max-w-5xl w-full mx-auto flex flex-col-reverse md:flex-row items-center justify-center gap-12">
        <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left">
          <h2 className="text-4xl font-pacifico font-extrabold mb-4 underline decoration-blue-400 decoration-2 underline-offset-8">
            Sobre nós
          </h2>
          <p className="text-lg text-neutral-700 font-poppins max-w-2xl mb-6">
          ...
          <Link
            href="#contato"
            className="inline-block px-6 py-2 font-poppins bg-blue-600 text-white rounded hover:bg-blue-700 transition"
          >
            Fale conosco
          </Link>
        </div>
