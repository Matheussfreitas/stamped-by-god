...
export default function ProductCard({ name, image }: ProductCardProps) {
  return (
    <Card className="relative overflow-hidden aspect-square w-full max-w-xs hover:scale-105 transition-transform shadow-lg">
      <CardContent className="p-0 h-full">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center z-10 bg-black/40 px-4 text-center">
          ...
          <Button className="mt-1 px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition">
            Ver mais
          </Button>
        </div>
      </CardContent>
